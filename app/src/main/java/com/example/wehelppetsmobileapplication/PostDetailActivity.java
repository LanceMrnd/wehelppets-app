...
import com.example.wehelppetsmobileapplication.adapters.AdapterComments;
import com.example.wehelppetsmobileapplication.models.ModelComment;
...
public class PostDetailActivity extends AppCompatActivity {
    ...
    TextView uNameTv, pTimeTiv, pTitleTv,pLocationTv, pDescriptionTv, pLikesTv, pCommentsTv, uRoleTv;
    ImageButton moreBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uRoleTv = findViewById(R.id.pRoleTv);
        ...
        shareBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    //post without image
                    shareTextOnly(pTitle,pLocation, pDescription);
                }
                else
                {
                    //post with image
                    ...
                    shareImageAndText(pTitle,pLocation, pDescription, bitmap);
                }*/
            }
        });
    }
    ...
    private void shareImageAndText(String pTitle,String pLocation, String pDescription, Bitmap bitmap) {
    ...
    private Uri saveImageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            stream.flush();
            stream.close();
            uri = FileProvider.getUriForFile(this, "com.example.wehelppetsmobileapplication.fileprovider", file);
        }
        catch (Exception e)
        {
    ...
    private void deleteWithImage() {
            ...
            fquery.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    Toast.makeText(PostDetailActivity.this, "Delete Message Successfully", Toast.LENGTH_SHORT).show();
                    pd.dismiss();
                }
        ...
        likesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.child(postId).hasChild(myUid)){
                    likeBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_hearted_pink,0,0,0);
                    likeBtn.setText("Loved");
                }
                else
                {
                    likeBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_heart_pink,0,0,0);
                    likeBtn.setText("Love");
                }
            }
        ...
        likesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(mProcessLike){
                    ...
                    {
                        postsRef.child(postId).child("pLikes").setValue(""+(Integer.parseInt(pLikes)+1));
                        likesRef.child(postId).child(myUid).setValue("Loved");
        ...
        myRef.orderByChild("uid").equalTo(myUid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren())
                {
                    ...
                    try {
                        Picasso.get().load(myDp).placeholder(R.drawable.profile_paws).into(cAvatarIv);

                    }
                    catch (Exception e)
                    {
                        Picasso.get().load(R.drawable.profile_paws).into(cAvatarIv);
                    }
                }
            }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren())
                {
                    ...
                    String uRole = "" + ds.child("uRole").getValue();
    ...
    private void checkUserStatus(){
        ...
        {
            //user not signed in, got to mainactivity
